...
public class RxLifecycleUtils {
     ...
     * @return
     */
    public static <T> LifecycleTransformer<T> bindUntilEvent(   final IView view,
    ...
    public static <T, R> LifecycleTransformer<T> bindUntilEvent(   final Lifecycleable<R> lifecycleable,
                                                                final R event) {
