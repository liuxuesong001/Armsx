...
public abstract class ClientModule {
    ...
    @Singleton
    @Provides
    static Retrofit provideRetrofit(Application application,   RetrofitConfiguration configuration, Retrofit.Builder builder, OkHttpClient client
    ...
    @Singleton
    @Provides
    static OkHttpClient provideClient(Application application,   OkhttpConfiguration configuration, OkHttpClient.Builder builder, Interceptor intercept
            ,   List<Interceptor> interceptors,   GlobalHttpHandler handler, ExecutorService executorService) {
        builder
    ...
    @Singleton
    @Provides
    static RxCache provideRxCache(Application application,   RxCacheConfiguration configuration
